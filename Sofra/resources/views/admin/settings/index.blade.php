             ...
             <table class="table table-bordered">
                <thead>
                  <tr>
                    ...
                    <th class="text-center">Max Credit</th>
                    <th class="text-center">App Commission</th>
                ...
                <tbody>
                  @foreach($records as $record)
                     <tr>
                       ...
                       <td class="text-center">{{ $record->text1}}</td>
                       <td class="text-center">{{ $record->text2}}</td>
                       <td class="text-center">{{ $record->max_credit}}</td>
                       <td class="text-center">{{ $record->app_commission}}</td>
                       ...
                       <td class="text-center">
                         {!! Form::open([
                            'action' => ['Admin\SettingController@destroy', $record->id],
                            'method' => 'delete'
                         ]) !!}
